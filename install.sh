...
uclient-fetch -qO /etc/init.d/bearDropper http://rawgit.com/JelmerT/bearDropper/master/src/init.d/bearDropper
uclient-fetch -qO /etc/config/bearDropper http://rawgit.com/JelmerT/bearDropper/master/src/config/bearDropper
uclient-fetch -qO /usr/sbin/bearDropper http://rawgit.com/JelmerT/bearDropper/master/bearDropper

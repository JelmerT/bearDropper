...
wget -qO /etc/init.d/bearDropper http://rawgit.com/JelmerT/bearDropper/master/src/init.d/bearDropper
wget -qO /etc/config/bearDropper http://rawgit.com/JelmerT/bearDropper/master/src/config/bearDropper
wget -qO /usr/sbin/bearDropper http://rawgit.com/JelmerT/bearDropper/master/bearDropper
